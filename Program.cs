    ...
    <main class='container'>
        <section class='rules'>
            ...
            <ul>
                ...
                <li>
                  <strong>보상을 받은 후 출석 일수는 초기화되며</strong> 다음 출석부터 1일로 다시 시작됩니다.<br>
                  <small>
                    (출석체크 후 반드시 길챗에 카운트 1..2..3...7 이렇게 남겨주시면 됩니다.<br>
                    최종 출첵 완료 시 <strong>7_(본계 닉)</strong> 또는 <strong>5_(본계 닉)</strong> 형태로 남겨주세요.)
                  </small>
                </li>
                <li><strong>2일 이상 미접 + 미출첵 하시는 분들은 추방조치</strong>되며 이런 일은 발생하면 안되지만 5일 출첵 후 5_닉네임 안 남겨주시고, 2일 이상 미출첵하시면 엽서는 지급되지 않습니다.<br>
                <li><strong>17일 이후로는 반드시 00시05분 이후로 출석체크 부탁드리며</strong> 05분 이전에 출첵하신 분은 무효처리입니다.(0회)<br>
            </ul>
        </section>
        ...
        <section class='notes'>
            ...
            <p>기존에 없던 요구사항이 자꾸 생겨서 용병님들에게 불편함을 느끼게 해드려서 죄송합니다.</p>
            <p>이후로는 크게 변경사항은 없을 것이며 추후 공지사항 생겼을 땐 사전에 미리 공지드리겠습니다.</p>
